...
public class ServiceJoueurMockPseudoIdentique implements IServicesJoueur {
    ...
    @Override
    public JoueurDTO ajouterJoueur(String nom, String pseudo, int anneeNaissance, Langues langue, HashSet<String> centreInteret) throws JoueurDejaExistantException {
