...
public class ServiceJoueurMockCentreInteretVide implements IServicesJoueur {
    ...
    @Override
    public JoueurDTO ajouterJoueur(String nom, String pseudo, int annéeNaissance, Langues langue, HashSet<String> centreInteret) throws  CentresInteretVidesException{
