...
public class ServiceJoueurMockNomOuPseudoLongueur implements IServicesJoueur {
    ...
    @Override
    public JoueurDTO ajouterJoueur(String nom, String pseudo, int annéeNaissance, Enum langue, HashSet<String> centreInteret) throws NomOuPseudoLongueurException {
